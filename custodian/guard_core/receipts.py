"""Value-free, HMAC hash-chained receipts shared by guard harnesses."""
...
class ReceiptChain:
    ...
    def append(self, decision: dict[str, Any], *, tool: str, session_id: str,
        ...
        with self._lock, _process_lock(self.lock_path):
            ...
            if decision.get("monitor_observation"):
                body["monitor_observation"] = _redact_reason(
                    str(decision["monitor_observation"])
                )[:512]
