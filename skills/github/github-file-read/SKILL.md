...
description: "Read a file from a public GitHub repository at a given ref"
version: 1.0.0
author: custodian
license: MIT
...
Read a file from a public GitHub repository at a given ref
...
```bash
custodian tools run github-file-read --param value
```
