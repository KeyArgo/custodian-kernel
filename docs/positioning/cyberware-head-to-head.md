...
| Tamper-evident ledger / provenance | ✅ | ✅ (hash-chained Caduceus audit; kernel receipts) |
...
runs. **Custodian + Caduceus encrypts secrets at rest** (AES-256-GCM,
...
- **TSA-anchored receipts.** Our audit chain proves ordering and
  ...
  non-repudiation. `caduceus.receipts` co-signing is the first step.
